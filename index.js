...
/////////////////
const BotName = 'Akeno-san☄'; 
const instagram = 'https://www.instagram.com/irsyafli_o.a'; 
const telegram = 'https://t.me/bukantubuh'; 
const kapanbotaktif = 'KETIKA HANYA DIAKTIFKAN'; 
const youtube = 'https://www.youtube.com/channel/UCaM9_PfKQ1UM4cROIcoS1YA/featured?view_as=subscriber';
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@irsyafli_o.a')
